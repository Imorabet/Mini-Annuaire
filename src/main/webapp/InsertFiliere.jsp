<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.example.web.dao.DepartementDao" %>
...
<%
	...
	<div class="content p-2">
		...
		<div class="row justify-content-center w-100">
			<div class="col-4">
				<h3 class="text-center mt-3 mb-5">Insérer une filière</h3>
				<div class="card p-4 bg-body-tertiary" style="width: 100%;">
					<form method="post" action="insertFiliere">
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Nom de
								département</label> <select class="form-select"
								aria-label="Default select example" name="id_departement" required>
								<option disabled selected>Sélectionner</option><% DepartementDao
								departementDao = new DepartementDao(); List
								<Departement> departements =
								departementDao.getDepartements(); for (Departement
								departement : departements) { %>
						...
						<div class="mb-3">
							<label for="exampleInputEmail1" class="form-label">Nom de
								filière</label> <input type="text" class="form-control"
