...
<body>
	...
	<div class="content p-2">
		<div class="row justify-content-center w-100">
			<div class="col-8">
				<h3 class="m-2">Résultat de la recherche :</h3>
				<table
					class="table table-body-tertiary table-hover table-responsive my-4">
					<thead class="table-dark">
						<tr>
							<th scope="col">#</th>
							<th scope="col">la filière</th>
							<th scope="col">sa département</th>
						</tr>
					</thead>
					<tbody>
						<%
						...
						%>
						<tr>
							<td colspan="3" class="text-center">Aucune filière trouvé avec le nom "<%=request.getParameter("searchNom")%>"</td>
						</tr>
						<%
						} else {
